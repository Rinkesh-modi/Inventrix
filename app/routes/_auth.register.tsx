...
//             type="text"
//             id="name"
//             className="w-full py-3 px-2 border-b-black border-b  bg-gray-300 text-black outline-none focus:rounded-md focus:bg-gray-200"
...
//         <div className="mb-3">
//           <CustomButtons type="submit" text="Register" loading={loading} />
//         </div>
//         <div className="mb-3">
